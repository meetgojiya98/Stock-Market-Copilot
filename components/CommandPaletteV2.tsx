...
const PAGE_ENTRIES: PaletteItem[] = [
  ...
  { id: "p-analytics", label: "Analytics", route: "/analytics", keywords: ["charts", "stats", "metrics"], icon: <BarChart3 size={16} />, category: "pages" },
  { id: "p-watchlist", label: "Watchlist", route: "/watchlist", keywords: ["watch", "track", "follow"], icon: <ListOrdered size={16} />, category: "pages" },
  { id: "p-screener", label: "Screener", route: "/screener", keywords: ["filter", "scan", "screen"], icon: <Search size={16} />, category: "pages" },
  { id: "p-trending", label: "Trending", route: "/trending", keywords: ["hot", "popular", "movers"], icon: <TrendingUp size={16} />, category: "pages" },
  { id: "p-alerts", label: "Price Alerts", route: "/notifications", keywords: ["alert", "notify", "price"], icon: <Bell size={16} />, category: "pages" },
  ...
  { id: "p-heatmap", label: "Portfolio Heatmap", route: "/heatmap", keywords: ["heat", "map", "sector"], icon: <PieChart size={16} />, category: "pages" },
  { id: "p-dividends", label: "Dividends", route: "/dividends", keywords: ["dividend", "yield", "income", "payout"], icon: <Wallet size={16} />, category: "pages" },
  { id: "p-calendar", label: "Earnings Calendar", route: "/calendar", keywords: ["earnings", "calendar", "dates", "schedule"], icon: <Calendar size={16} />, category: "pages" },
  { id: "p-glossary", label: "Glossary", route: "/glossary", keywords: ["terms", "definitions", "glossary", "learn"], icon: <BookOpen size={16} />, category: "pages" },
  { id: "p-sectors", label: "Sector Performance", route: "/sectors", keywords: ["sector", "industry", "performance"], icon: <PieChart size={16} />, category: "pages" },
  { id: "p-simulator", label: "What-If Simulator", route: "/simulator", keywords: ["simulate", "what if", "scenario"], icon: <Play size={16} />, category: "pages" },
  { id: "p-ideas", label: "AI Trade Ideas", route: "/ideas", keywords: ["ai", "trade", "idea", "suggestion"], icon: <Lightbulb size={16} />, category: "pages" },
  { id: "p-strategies", label: "Strategy Library", route: "/strategies", keywords: ["strategy", "plan", "backtest"], icon: <Target size={16} />, category: "pages" },
  { id: "p-goals", label: "Goal Tracker", route: "/goals", keywords: ["goal", "target", "milestone"], icon: <Target size={16} />, category: "pages" },
  { id: "p-journal", label: "Trade Journal", route: "/journal", keywords: ["journal", "log", "diary", "notes"], icon: <FileText size={16} />, category: "pages" },
  { id: "p-community", label: "Community", route: "/community", keywords: ["discuss", "forum", "social", "community"], icon: <Users size={16} />, category: "pages" },
  { id: "p-export", label: "Data Export", route: "/export", keywords: ["export", "csv", "download", "data"], icon: <Upload size={16} />, category: "pages" },
  { id: "p-profile", label: "Profile", route: "/profile", keywords: ["profile", "account", "settings", "user"], icon: <Settings size={16} />, category: "pages" },
  { id: "p-sentiment", label: "Sentiment", route: "/sentiment", keywords: ["sentiment", "mood", "fear", "greed"], icon: <Zap size={16} />, category: "pages" },
  { id: "p-options", label: "Options", route: "/options", keywords: ["options", "calls", "puts", "derivatives"], icon: <LineChart size={16} />, category: "pages" },
  { id: "p-crypto", label: "Crypto", route: "/crypto", keywords: ["crypto", "bitcoin", "ethereum", "coin"], icon: <Hash size={16} />, category: "pages" },
  { id: "p-research", label: "Research", route: "/research", keywords: ["research", "report", "analysis"], icon: <FileText size={16} />, category: "pages" },
  { id: "p-execution", label: "Execution Hub", route: "/execution", keywords: ["execute", "order", "trade", "buy", "sell"], icon: <Zap size={16} />, category: "pages" },
  { id: "p-benchmarks", label: "Benchmarks", route: "/benchmarks", keywords: ["benchmark", "index", "sp500"], icon: <BarChart3 size={16} />, category: "pages" },
  { id: "p-briefing", label: "Morning Briefing", route: "/briefing", keywords: ["morning", "briefing", "summary", "daily"], icon: <Newspaper size={16} />, category: "pages" },
  { id: "p-broker", label: "Broker Connect", route: "/broker", keywords: ["broker", "connect", "brokerage", "link"], icon: <Globe size={16} />, category: "pages" },
  { id: "p-learn", label: "Learn", route: "/learn", keywords: ["learn", "education", "tutorial", "course"], icon: <BookOpen size={16} />, category: "pages" },
  { id: "p-audit", label: "Audit Trail", route: "/audit", keywords: ["audit", "history", "log", "trail"], icon: <Clock size={16} />, category: "pages" },
  { id: "p-transcripts", label: "Transcripts", route: "/transcripts", keywords: ["transcript", "earnings call", "conference"], icon: <FileText size={16} />, category: "pages" },
  { id: "p-replay", label: "Market Replay", route: "/replay", keywords: ["replay", "rewind", "historical"], icon: <Play size={16} />, category: "pages" },
  { id: "p-workspace", label: "Workspace", route: "/workspace", keywords: ["workspace", "layout", "custom", "arrange"], icon: <LayoutDashboard size={16} />, category: "pages" },
  { id: "p-notifications", label: "Notifications", route: "/notifications", keywords: ["notification", "inbox", "messages"], icon: <Bell size={16} />, category: "pages" },
  { id: "p-data", label: "Data Manager", route: "/data", keywords: ["data", "import", "manage"], icon: <Cpu size={16} />, category: "pages" },
