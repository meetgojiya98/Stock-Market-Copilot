...
export default function PageShell({
  ...
  return (
    <div className={`pro-container py-4 sm:py-5 lg:py-6 space-y-3 sm:space-y-4 transition-all duration-300 ease-out ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-1"}`}>
